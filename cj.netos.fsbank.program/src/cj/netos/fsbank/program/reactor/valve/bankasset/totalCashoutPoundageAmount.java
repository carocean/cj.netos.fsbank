...
@CjService(name = "bankasset.totalCashoutPoundageAmount")
public class totalCashoutPoundageAmount implements IValve {
	...
	public void flow(Event e, IPipeline pipeline) throws CircuitException {
		...
		BigDecimal totalCashoutPoundageAmount = bankAssetBS.totalCashoutPoundageAmount(e.getKey());
