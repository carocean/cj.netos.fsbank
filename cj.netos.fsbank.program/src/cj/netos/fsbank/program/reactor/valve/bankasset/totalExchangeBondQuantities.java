...
@CjService(name = "bankasset.totalExchangeBondQuantities")
public class totalExchangeBondQuantities implements IValve {
	...
	public void flow(Event e, IPipeline pipeline) throws CircuitException {
		...
		BigDecimal totalExchangeBondQuantities = bankAssetBS.totalExchangeBondQuantities(e.getKey());
