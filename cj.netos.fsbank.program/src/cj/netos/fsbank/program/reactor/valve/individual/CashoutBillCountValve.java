...
@CjService(name = "individual.cashoutBillCount")
public class CashoutBillCountValve implements IValve {
	...
	public void flow(Event e, IPipeline pipeline) throws CircuitException {
		...
		long cashoutBillCount = fSBankIndividualAccountAssetBS.cashoutBillCount(e.getKey(), cashoutor,identity);
		
		Map<String, Object> map = new HashMap<String, Object>();
		map.put("cashoutBillCount", new Gson().toJson(cashoutBillCount));
