...
@CjService(name = "individual.totalDepositBondAmount")
public class TotalDepositBondAmountValve implements IValve {
	...
	public void flow(Event e, IPipeline pipeline) throws CircuitException {
		...
		BigDecimal totalDepositBondAmount = fSBankIndividualAccountAssetBS.totalDepositBondAmount(e.getKey(), depositor);
		
		Map<String, Object> map = new HashMap<String, Object>();
		map.put("totalDepositBondAmount", new Gson().toJson(totalDepositBondAmount));
