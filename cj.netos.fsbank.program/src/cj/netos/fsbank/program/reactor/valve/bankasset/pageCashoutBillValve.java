...
@CjService(name = "bankasset.pageCashoutBill")
public class pageCashoutBillValve implements IValve {
	...
	public void flow(Event e, IPipeline pipeline) throws CircuitException {
		...
		List<?> pageCashoutBill = bankAssetBS.pageCashoutBill(e.getKey(),currPage,pageSize);
		
		Map<String, Object> map = new HashMap<String, Object>();
		map.put("cashoutBills", new Gson().toJson(pageCashoutBill));
