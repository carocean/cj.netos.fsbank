...
@CjService(name = "bankasset.totalDepositReserveAmount")
public class totalDepositReserveAmount implements IValve {
	...
	public void flow(Event e, IPipeline pipeline) throws CircuitException {
		...
		BigDecimal totalDepositReserveAmount = bankAssetBS.totalDepositReserveAmount(e.getKey());
