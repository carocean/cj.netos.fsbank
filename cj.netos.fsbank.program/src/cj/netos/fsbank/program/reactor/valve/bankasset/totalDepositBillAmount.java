...
@CjService(name = "bankasset.totalDepositBillAmount")
public class totalDepositBillAmount implements IValve {
	...
	public void flow(Event e, IPipeline pipeline) throws CircuitException {
		...
		BigDecimal totalDepositBillAmount = bankAssetBS.totalDepositBillAmount(e.getKey());
