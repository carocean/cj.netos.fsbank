...
@CjService(name = "individual.exchangeBillCount")
public class ExchangeBillCountValve implements IValve {
	...
	public void flow(Event e, IPipeline pipeline) throws CircuitException {
		...
		long exchangeBillCount = fSBankIndividualAccountAssetBS.exchangeBillCount(e.getKey(), exchanger);
		
		Map<String, Object> map = new HashMap<String, Object>();
		map.put("exchangeBillCount", new Gson().toJson(exchangeBillCount));
