...
@CjService(name = "bankasset.totalCashoutReqAmount")
public class totalCashoutReqAmount implements IValve {
	...
	public void flow(Event e, IPipeline pipeline) throws CircuitException {
		...
		BigDecimal totalCashoutReqAmount = bankAssetBS.totalCashoutReqAmount(e.getKey());
