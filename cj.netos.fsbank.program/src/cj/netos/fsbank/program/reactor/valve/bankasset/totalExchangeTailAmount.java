...
@CjService(name = "bankasset.totalExchangeTailAmount")
public class totalExchangeTailAmount implements IValve {
	...
	public void flow(Event e, IPipeline pipeline) throws CircuitException {
		...
		BigDecimal totalExchangeTailAmount = bankAssetBS.totalExchangeTailAmount(e.getKey());
