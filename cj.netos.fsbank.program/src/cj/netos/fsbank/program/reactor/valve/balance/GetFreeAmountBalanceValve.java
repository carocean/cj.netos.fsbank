...
@CjService(name = "balance.getFreeAmountBalance")
public class GetFreeAmountBalanceValve implements IValve {
	...
	public void flow(Event e, IPipeline pipeline) throws CircuitException {
		...
		BigDecimal freeAmount = fSBankBalance.getFreeAmountBalance(e.getKey());
		
		Map<String, Object> map = new HashMap<String, Object>();
		map.put("freeAmountBalance", new Gson().toJson(freeAmount));
