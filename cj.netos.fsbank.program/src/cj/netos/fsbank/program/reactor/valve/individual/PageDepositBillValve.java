...
@CjService(name = "individual.pageDepositBill")
public class PageDepositBillValve implements IValve {
	...
	public void flow(Event e, IPipeline pipeline) throws CircuitException {
		...
		List<?> list = fSBankIndividualAccountAssetBS.pageDepositBill(e.getKey(), depositor, currPage, pageSize);

		Map<String, Object> map = new HashMap<String, Object>();
		map.put("depositBills", new Gson().toJson(list));
