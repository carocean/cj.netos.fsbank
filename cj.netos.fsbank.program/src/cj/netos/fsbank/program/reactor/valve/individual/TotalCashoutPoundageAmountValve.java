...
@CjService(name = "individual.totalCashoutPoundageAmount")
public class TotalCashoutPoundageAmountValve implements IValve {
	...
	public void flow(Event e, IPipeline pipeline) throws CircuitException {
		...
		BigDecimal totalCashoutPoundageAmount = fSBankIndividualAccountAssetBS.totalCashoutPoundageAmount(e.getKey(), cashoutor,identity);
		
		Map<String, Object> map = new HashMap<String, Object>();
		map.put("totalCashoutPoundageAmount", new Gson().toJson(totalCashoutPoundageAmount));
