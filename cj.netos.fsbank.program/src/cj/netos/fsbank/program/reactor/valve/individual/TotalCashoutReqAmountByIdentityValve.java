...
@CjService(name = "individual.totalCashoutReqAmountByIdentity")
public class TotalCashoutReqAmountByIdentityValve implements IValve {
	...
	public void flow(Event e, IPipeline pipeline) throws CircuitException {
		...
		BigDecimal totalCashoutReqAmountByIdentity = fSBankIndividualAccountAssetBS
				.totalCashoutReqAmountByIdentity(e.getKey(), identity);

		Map<String, Object> map = new HashMap<String, Object>();
		map.put("totalCashoutReqAmountByIdentity", new Gson().toJson(totalCashoutReqAmountByIdentity));
