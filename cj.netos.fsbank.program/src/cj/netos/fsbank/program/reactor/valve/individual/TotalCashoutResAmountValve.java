...
@CjService(name = "individual.totalCashoutReqAmount")
public class TotalCashoutResAmountValve implements IValve {
	...
	public void flow(Event e, IPipeline pipeline) throws CircuitException {
		...
		BigDecimal totalCashoutReqAmount = fSBankIndividualAccountAssetBS.totalCashoutReqAmount(e.getKey(), cashoutor,identity);
		
		Map<String, Object> map = new HashMap<String, Object>();
		map.put("totalCashoutReqAmount", new Gson().toJson(totalCashoutReqAmount));
