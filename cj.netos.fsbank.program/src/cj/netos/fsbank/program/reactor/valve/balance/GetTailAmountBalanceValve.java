...
@CjService(name = "balance.getTailAmountBalance")
public class GetTailAmountBalanceValve implements IValve {
	...
	public void flow(Event e, IPipeline pipeline) throws CircuitException {
		...
		BigDecimal tailAmount = fSBankBalance.getTailAmountBalance(e.getKey());
		
		Map<String, Object> map = new HashMap<String, Object>();
		map.put("tailAmountBalance", new Gson().toJson(tailAmount));
