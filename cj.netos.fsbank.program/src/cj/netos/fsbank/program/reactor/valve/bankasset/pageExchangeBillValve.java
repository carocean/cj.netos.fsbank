...
@CjService(name = "bankasset.pageExchangeBill")
public class pageExchangeBillValve implements IValve {
	...
	public void flow(Event e, IPipeline pipeline) throws CircuitException {
		...
		List<?> pageExchangeBill = bankAssetBS.pageExchangeBill(e.getKey(),currPage,pageSize);
		
		Map<String, Object> map = new HashMap<String, Object>();
		map.put("exchangeBills", new Gson().toJson(pageExchangeBill));
