...
@CjService(name = "bankasset.totalDepositBondAmount")
public class totalDepositBondAmount implements IValve {
	...
	public void flow(Event e, IPipeline pipeline) throws CircuitException {
		...
		BigDecimal totalDepositBondAmount = bankAssetBS.totalDepositBondAmount(e.getKey());
