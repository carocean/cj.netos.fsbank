...
@CjService(name = "bankasset.cashBillCount")
public class CashBillCountVavle implements IValve {
	...
	public void flow(Event e, IPipeline pipeline) throws CircuitException {
		...
		long cashBillCount = bankAssetBS.cashBillCount(e.getKey());
		
		Map<String, Object> map = new HashMap<String, Object>();
		map.put("cashBillCount", new Gson().toJson(cashBillCount));
