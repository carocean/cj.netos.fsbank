...
@CjService(name = "individual.totalCashoutResAmountByIdentity")
public class TotalCashoutResAmountByIdentityValve implements IValve {
	...
	public void flow(Event e, IPipeline pipeline) throws CircuitException {
		...
		BigDecimal totalCashoutResAmountByIdentity = fSBankIndividualAccountAssetBS
				.totalCashoutResAmountByIdentity(e.getKey(), identity);

		Map<String, Object> map = new HashMap<String, Object>();
		map.put("totalCashoutResAmountByIdentity", new Gson().toJson(totalCashoutResAmountByIdentity));
