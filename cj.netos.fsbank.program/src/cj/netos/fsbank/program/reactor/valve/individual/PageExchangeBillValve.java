...
@CjService(name = "individual.pageExchangeBill")
public class PageExchangeBillValve implements IValve {
	...
	public void flow(Event e, IPipeline pipeline) throws CircuitException {
		...
		List<?> list = fSBankIndividualAccountAssetBS.pageExchangeBill(e.getKey(), exchanger, currPage, pageSize);

		Map<String, Object> map = new HashMap<String, Object>();
		map.put("exchangeBills", new Gson().toJson(list));
