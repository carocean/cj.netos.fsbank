...
@CjService(name = "individual.totalCashoutResAmount")
public class TotalCashoutReqAmountVavle implements IValve {
	...
	public void flow(Event e, IPipeline pipeline) throws CircuitException {
		...
		BigDecimal totalCashoutResAmount = fSBankIndividualAccountAssetBS.totalCashoutResAmount(e.getKey(), cashoutor,identity);
		
		Map<String, Object> map = new HashMap<String, Object>();
		map.put("totalCashoutResAmount", new Gson().toJson(totalCashoutResAmount));
