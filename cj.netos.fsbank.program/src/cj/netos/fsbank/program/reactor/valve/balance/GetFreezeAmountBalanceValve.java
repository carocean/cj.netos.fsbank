...
@CjService(name = "balance.getFreezeAmountBalance")
public class GetFreezeAmountBalanceValve implements IValve {
	...
	public void flow(Event e, IPipeline pipeline) throws CircuitException {
		...
		BigDecimal freezeAmount = fSBankBalance.getFreezeAmountBalance(e.getKey());
		
		Map<String, Object> map = new HashMap<String, Object>();
		map.put("freezeAmountBalance", new Gson().toJson(freezeAmount));
