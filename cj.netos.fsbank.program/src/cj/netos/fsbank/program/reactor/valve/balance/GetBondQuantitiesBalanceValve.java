...
@CjService(name = "balance.getBondQuantitiesBalance")
public class GetBondQuantitiesBalanceValve implements IValve {
	...
	public void flow(Event e, IPipeline pipeline) throws CircuitException {
		...
		BigDecimal bondQuantitiesBalance = fSBankBalance.getBondQuantitiesBalance(e.getKey());
		
		Map<String, Object> map = new HashMap<String, Object>();
		map.put("bondQuantitiesBalance", new Gson().toJson(bondQuantitiesBalance));
