...
@CjService(name = "individual.totalDepositBondQuantities")
public class TotalDepositBondQuantitiesValve implements IValve {
	...
	public void flow(Event e, IPipeline pipeline) throws CircuitException {
		...
		BigDecimal totalDepositBondQuantities = fSBankIndividualAccountAssetBS.totalDepositBondQuantities(e.getKey(), depositor);
