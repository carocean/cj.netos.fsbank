...
@CjService(name = "individual.totalDepositFreeAmount")
public class TotalDepositFreeAmountVavle implements IValve {
	...
	public void flow(Event e, IPipeline pipeline) throws CircuitException {
		...
		BigDecimal totalDepositFreeAmount = fSBankIndividualAccountAssetBS.totalDepositFreeAmount(e.getKey(), depositor);
