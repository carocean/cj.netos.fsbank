...
@CjService(name = "bankasset.totalCashoutResAmount")
public class totalCashoutResAmount implements IValve {
	...
	public void flow(Event e, IPipeline pipeline) throws CircuitException {
		...
		BigDecimal totalCashoutResAmount = bankAssetBS.totalCashoutResAmount(e.getKey());
