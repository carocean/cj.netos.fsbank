...
@CjService(name = "individual.totalDepositReserveAmount")
public class TotalDepositReserveAmountValve implements IValve {
	...
	public void flow(Event e, IPipeline pipeline) throws CircuitException {
		...
		BigDecimal totalDepositReserveAmount = fSBankIndividualAccountAssetBS.totalDepositReserveAmount(e.getKey(), depositor);
		
		Map<String, Object> map = new HashMap<String, Object>();
		map.put("totalDepositReserveAmount", new Gson().toJson(totalDepositReserveAmount));
