...
@CjService(name = "individual.totalExchangeBondQuantities")
public class TotalExchangeBondQuantitiesValve implements IValve {
	...
	public void flow(Event e, IPipeline pipeline) throws CircuitException {
		...
		BigDecimal totalExchangeBondQuantities = fSBankIndividualAccountAssetBS.totalExchangeBondQuantities(e.getKey(), exchanger);
		
		Map<String, Object> map = new HashMap<String, Object>();
		map.put("totalExchangeBondQuantities", new Gson().toJson(totalExchangeBondQuantities));
