...
@CjService(name = "individual.totalDepositBillAmount")
public class TotalDepositBillAmountValve implements IValve {
	...
	public void flow(Event e, IPipeline pipeline) throws CircuitException {
		...
		BigDecimal totalDepositBillAmount = fSBankIndividualAccountAssetBS.totalDepositBillAmount(e.getKey(), depositor);
		
		Map<String, Object> map = new HashMap<String, Object>();
		map.put("totalDepositBillAmount", new Gson().toJson(totalDepositBillAmount));
